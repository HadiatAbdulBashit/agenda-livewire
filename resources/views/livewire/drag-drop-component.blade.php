<div x-data="dragDrop()">
    ...
    <div class="card" x-on:dragover.prevent="dragover" x-on:dragleave.prevent="dragleave"
    ...
    <div class="progress">
        <div class="progress-bar" role="progress-bar" :style="{ width: uploadProgress + '%' }" aria-valuemin="0"
            aria-valuemax="100" x-text="uploadProgress+'%'"></div>
    </div>
    @foreach ($files as $file)
        <ul class="list-group ">
            ...
            <li wire:key="({{ $loop->index }})"
                ...
                <svg wire:click="remove({{ $loop->index }})" xmlns="http://www.w3.org/2000/svg" width="16"
